...
int main() {
  ...
  name = new char[50]; description = new char[500]; strcpy(name, "Lower_Engine"); strcpy(description, "You are in the upper engine room. The engine’s fuel gauge is getting low. You will need to refill it for the journey home.");
  rooms.push_back(new Room(name, description)); delete[] name; delete[] description;
